...
public class Sanitizer {
    ...
    public static String addressSanitizer(String entity){
        if(entity == null || entity.isEmpty()) throw new IllegalArgumentException("Address for Sanitization Cannot be Empty or null");
    ...
    public static String emailSanitizer(String entity){
        if(entity == null || entity.isEmpty()) throw new IllegalArgumentException("Email Address for Sanitization Cannot be Empty or null");
        //remove domain
    ...
    public static String nameSanitizer(String entity){
        if(entity == null || entity.isEmpty()) throw new IllegalArgumentException("Name for Sanitization Cannot be Empty or null");
        //replace all characters except alphabets
        entity = entity.replaceAll("[^a-zA-Z]","");
        //convert alphabets to small
        entity = entity.toLowerCase();
